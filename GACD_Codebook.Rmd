...
The remainder of the variables are accelerometer measurements. Each column gives the mean of all measurements for the activity type and subject_id given in columns 1 and 2, as indicated by the prefix 'Mean'.  
